...
export const [AuthProvider, useAuth] = createContextHook(() => {
  ...
  const loadState = async (isRetry = false) => {
    ...
    try {
      const [onboarding, login, profile, verification, documents, training, setup, managerOTP, permissions, phoneNumber, userProfile, documentUploads, trainingProgress, locationType, selectedShifts, shiftActive, shiftStartTime, notifications] = await Promise.race([
        storagePromise,
        timeoutPromise,
      ]);
